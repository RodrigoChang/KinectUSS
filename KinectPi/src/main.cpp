...
bool enable_rgb, enable_depth, enable_ogl, enable_viewer, enable_stream, enable_cloud, enable_z_stream, onStreaming = true, protonect_shutdown = false;
...
int main() {
    ...
    for (const auto& pair : config) {
        ...
        if (pair.first == "viewer") {
            if (pair.second == "True") enable_viewer = true;
            else enable_viewer = false;
        }
        if (pair.first == "ogl") {
            if (pair.second == "True") enable_ogl = true;
            else enable_ogl = false;
        }
    } 
